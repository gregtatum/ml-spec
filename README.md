...
This repo includes three Levenstein distance implementations in `src/distance.rs`:

- `levenstein_distance_ref`: a reference dynamic programming implementation that
  materializes a full (m+1) x (n+1) table for clarity.
